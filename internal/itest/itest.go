...
// localhost / 127.0.0.1, writes the certificate and key as PEM files in
...
// ServerTLS loads a certificate/key pair into a server tls.Config.
func ServerTLS(t *testing.T, certFile, keyFile string) *tls.Config {
	t.Helper()
